 ...
 **/
double[] calcScaled( float x, float y, float wid, float hei, int areaOfInterestIndex, boolean isCheckingFace )
{
 ...
 **/
float[] checkShellWithinInterest(float x, float y, float w, float h, int areaOfInterestIndex, boolean isCheckingFace) 
{
